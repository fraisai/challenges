...
The result of using eitherCallback to combine two callbacks into one callback and then passing that one callback into filterArray should match the results of 
...
function eitherCallback(callback1, callback2) {
  ...
  function callback(element, index, array) {
    if (callback1(element, index, array) || callback2(element, index, array)) {
      return true
    }
  }
  return callback;
